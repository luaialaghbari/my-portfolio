...
export default function Footer({ resume, lang, yearRef }) {
  return (
    <footer className={`${styles.scope} footer-logo-container`}>
      ...
      <div className="footer-middle-row">
        ...
        © <span ref={yearRef} /> {lang === 'ar' ? 'لؤي الأغبري. جميع الحقوق محفوظة.' : 'Luai Alaghbari. All Rights Reserved.'}
      </div>
      </div>
